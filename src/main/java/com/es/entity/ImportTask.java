...
//	}
	...
	public ImportTask(int sprintId, String summary, String taskId, String taskDescription, int threePointEstimate, int aiEstimate, int actual, List<String> labels,
			int riskFactor) {
		super();
		this.sprintId = sprintId;
		this.summary = summary;
